...
<div class="bg-white text-orange-600 rounded-full w-32 h-32 flex
...
<div class="mb-8">
<h2 class="text-2xl font-bold text-gray-900 mb-6">Productos en
Oferta</h2>
...
<p class="text-gray-500 text-lg">No hay productos con esta
oferta actualmente.</p>
</div>
@endif
</div>
<!-- Botón volver -->
